...
TEST(circle, ostream)
{
    zx::mat::spherical_shape<float, 2> circle{ { 1.0f, 2.0f }, 5.0f };
...
{
    zx::mat::spherical_shape<double, 2> circle{ { 1.0, 2.0 }, 3.0 };
...
{
    zx::mat::spherical_shape<int, 2> circle{ { 10, 20 }, 7 };
...
TEST(sphere, ostream)
{
    zx::mat::spherical_shape<float, 3> sphere{ { 1.0f, 2.0f, 3.0f }, 5.0f };
