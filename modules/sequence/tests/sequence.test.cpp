...
TEST(sequence_t, default_constructed_is_empty)
{
    zx::sequence_t<int> seq = zx::sequence_t<int>{};
...
TEST(sequence_t, from_iterator)
{
    std::vector<int> vec = { 1, 2, 3, 4, 5 };
    zx::sequence_t<int> seq = zx::sequence_t<int>(vec.begin(), vec.end());
...
TEST(sequence_t, from_range)
{
    std::vector<int> vec = { 1, 2, 3, 4, 5 };
    zx::sequence_t<int> seq = zx::sequence_t<int>(vec);
...
TEST(sequence_t, from_owning_range)
{
    std::vector<int> vec = { 1, 2, 3, 4, 5 };
    zx::sequence_t<int> seq = zx::sequence_t<int>(std::move(vec), 0);
...
TEST(sequence_t, inspect_indexed)
{
    std::vector<int> vec = { 1, 2, 3 };
    zx::sequence_t<int> seq = zx::sequence_t<int>(vec);
...
TEST(sequence_t, transform_indexed)
{
    std::vector<int> vec = { 1, 2, 3 };
    zx::sequence_t<int> seq = zx::sequence_t<int>(vec);
...
TEST(sequence_t, filter_indexed)
{
...
TEST(sequence_t, transform_maybe)
{
    std::vector<int> vec = { 1, 2, 3, 4, 5 };
    zx::sequence_t<int> seq = zx::sequence_t<int>(vec);
...
TEST(sequence_t, transform_maybe_indexed)
{
...
TEST(sequence_t, take_while_indexed)
{
...
TEST(sequence_t, drop_while_indexed)
{
...
TEST(sequence_t, concat)
{
    zx::sequence_t<int> seq1 = zx::sequence_t<int>{ std::vector<int>{ 1, 2, 3 }, 0 };
    zx::sequence_t<int> seq2 = zx::sequence_t<int>{ std::vector<int>{ 4, 5 }, 0 };
    zx::sequence_t<int> seq3 = zx::sequence_t<int>{ std::vector<int>{ 6, 7, 8, 9 }, 0 };
...
{
    zx::sequence_t<int> seq1 = zx::sequence_t<int>{ std::vector<int>{ 1, 2, 3 }, 0 };
    zx::sequence_t<char> seq2 = zx::sequence_t<char>{ std::vector<char>{ 'a', 'b', 'c', 'd' }, 0 };
...
TEST(sequence_t, init_infinite)
{
    zx::sequence_t<int> seq = zx::seq::init_infinite([](std::ptrdiff_t index) { return static_cast<int>(index + 1); });
...
TEST(sequence_t, iota)
{
    zx::sequence_t<int> seq = zx::seq::iota(5);
...
TEST(sequence_t, range)
{
    zx::sequence_t<int> seq = zx::seq::range(3, 8);
...
TEST(sequence_t, range_empty)
{
    zx::sequence_t<int> seq = zx::seq::range(10, 5);
...
TEST(sequence_t, unfold)
{
    zx::sequence_t<std::string> seq = zx::seq::unfold(
...
TEST(sequence_t, repeat)
{
    zx::sequence_t<char> seq = zx::seq::repeat('x');
...
TEST(sequence_t, singleton)
{
    zx::sequence_t<int> seq = zx::seq::single(42);
...
TEST(sequence_t, vec)
{
    zx::sequence_t<const int&> seq = zx::seq::vec(1, 2, 3, 4, 5);
...
TEST(sequence_t, join)
{
    zx::sequence_t<zx::sequence_t<const int&>> seq_of_seqs
